...
from damage_repair.column_weights import TEXT_COMPARISON_COLS, EQUALITY_COMPARISON_COLS, ATTACHMENTS_WEIGHT
from damage_repair.config import PATH, FILTER_DATE, NORMALIZE_ARABIC_COLS, SIMILARITY_THRESHOLD, COMPARE_WITH_LEVENSHTEIN, \
    SIMILARITY_LEVELS
from utils import create_blank_df


def main():
    columns = ['id', 'repair_way', 'worker_repair_name', 'repair_to_datetime', 'repair_from_datetime',
    ...
    df = df[df['expenses_type'] == 'damage_repair']
