...
from machine_wash.column_weights import TEXT_COMPARISON_COLS, EQUALITY_COMPARISON_COLS, ATTACHMENTS_WEIGHT
from machine_wash.config import PATH, FILTER_DATE, NORMALIZE_ARABIC_COLS, SIMILARITY_THRESHOLD, COMPARE_WITH_LEVENSHTEIN, \
    SIMILARITY_LEVELS
from utils import create_blank_df


def main():
    columns = ['id', 'machine_location', 'machine_wash_tag', 'wash_date', 
    ...
    df = df[df['expenses_type'] == 'machine_wash']
