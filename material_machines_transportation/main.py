...
from material_machines_transportation.config import PATH, FILTER_DATE, NORMALIZE_ARABIC_COLS, SIMILARITY_THRESHOLD, \
    SIMILARITY_LEVELS, \
...
def main():
    columns = ['id', 'expenses_type', 'request_id', 'date_of_expenses',
               'transporter_name', 'operator_name', 'material_from_location', 'material_to_location', 'create_date']
